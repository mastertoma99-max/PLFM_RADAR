...
def symbol(name,embedded=False):
    ...
    body += prop('Reference',prefix,0,5.08,False)+prop('Value',value,0,-7.62,False)
...
sch = [f'''(kicad_sch (version 20250114) (generator "eeschema")
 ...
 (title_block (title "4 x 4 Phased Array - IPEX I Generation") (date "2026-09-20") (rev "IPEX1-A")
