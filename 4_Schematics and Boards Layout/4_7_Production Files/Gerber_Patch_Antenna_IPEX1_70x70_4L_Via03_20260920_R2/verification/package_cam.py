...
assert not audit['kicad_checks']['DRC_ignored_checks']
assert all(v['directly_connected_ground_vias']==44 and v['isolated_signal_vias']==16 for v in audit['individual_inner_ground_connections'].values())
...
files.append(checks)
archive=OUT/'Phased_Array_Ant_IPEX1_70x70_4L_Gerber_20260920_R2.zip'
