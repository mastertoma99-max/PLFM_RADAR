...
manifest={}
files=[NAME+'.kicad_pcb',NAME+'.kicad_sch',NAME+'.kicad_pro','PLFM_RF.kicad_sym','sym-lib-table','fp-lib-table','README_修改说明.md']
...
run('pcb','drc','--format','json','--schematic-parity','--refill-zones','--save-board','--exit-code-violations','-o',OUT/'verification/drc.json',board)
