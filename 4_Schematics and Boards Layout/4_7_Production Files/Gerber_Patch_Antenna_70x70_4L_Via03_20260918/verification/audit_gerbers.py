...
specs = [('F_Cu', 'gtl', 'F_Cu', 'gtl'), ('In1_Cu', 'g1', 'In1_Cu', 'g1'),
         ('In2_Cu', 'g2', 'In2_Cu', 'g2'), ('B_Cu', 'gbl', 'B_Cu', 'gbl'),
...
geoms, gerbers = {}, {}
changes = json.loads((OUT/'verification/via_change_audit.json').read_text())['modified_vias']
...
assert counts == {('PTH', 0.3): 28, ('NPTH', 3.2): 4}, counts
...
report['drill_readback'] = {'total_holes': len(drills), 'PTH_0.2mm': 0, 'PTH_0.3mm': 28, 'NPTH_3.2mm': 4,
...
for suffix in ('Via03','Via02_reference'):
...
d.text((24,20),'70 x 70 mm antenna PCB | 4 layers | 0.3 mm via holes',font=font,fill='white')
